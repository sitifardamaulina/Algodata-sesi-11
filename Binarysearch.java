...
public String[] languageInput;
  ...
  Binarysearch(String[][] languages) {
    ...
    public static void main(String[] args) {
        String[] english = {
      "flower", "cincin", "nurse", "shoes",
      "rabbit", "turtle", "clothes", "black"
    };

    String[] indonesia = {
      "bunga", "ring", "perawat", "sepatu",
      "kelinci", "kura kura", "baju", "hitam"
    };
    ...
    Binarysearch kamus = new Binarysearch(IND_TO_ENG);

    kamus.translate("kura kura");
